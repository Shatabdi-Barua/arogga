...
#                     print(ins)
                    ...
                    logging.basicConfig(level=logging.DEBUG, filename='logArogga.log', filemode='w',
    ...
    #                 print(reslt)
                ...
                logging.basicConfig(level=logging.DEBUG, filename='logArogga.log', filemode='w',
                                    format="{asctime} {levelname:<8} {message}", style='{',)
                logging.info(str(n)+ " status 404 inserted")
                db_sku.append(n)
    #         end_time = time.time()
            elif st_code == 308:
                ins = products.insert().values(sku=n, status = 0)
                ...
                logging.basicConfig(level=logging.DEBUG, filename='logArogga.log', filemode='w',
                                    format="{asctime} {levelname:<8} {message}", style='{',)
                logging.info(str(n)+" status 308 inserted")
                db_sku.append(n)
            else:
                error.append(n)
        except:
...
#             reslt = conn.execute(ins)
            ...
            logging.error(sys.exc_info()[0]+str(n))
            db_sku.append(n)
            break
    n= n-1
